...
def list_region_positions(request):
    ...
    return render(request, 'custom_admin/region/region_position/list.html', {'positions': positions})
...
def create_region_position(request):
    ...
    return render(request, 'custom_admin/region/region_position/create.html')
...
def edit_region_position(request, id):
    ...
    if request.method == 'POST':
        ...
        position.save()
        return redirect('list_region_positions')
    return render(request, 'custom_admin/region/region_position/edit.html', {'position': position})
...
def delete_region_position(request, id):
    ...
    if request.method == 'POST':
        position.delete()
        return redirect('list_region_positions')
    return render(request, 'custom_admin/region/region_position/delete.html', {'position': position})
