...
def state_list(request):
    ...
    return render(request, 'custom_admin/state_data/state_list.html', {'states': states})
...
def state_create(request):
    ...
    return render(request, 'custom_admin/state_data/state_form.html', {'countries': countries, 'operation': 'Create'})
...
def state_edit(request, state_id):
    ...
    if request.method == "POST":
        ...
        if state_name:
            ...
            state.save()
        return redirect('state_list')
    return render(request, 'custom_admin/state_data/state_form.html', {'state': state, 'countries': countries, 'operation': 'Edit'})
...
def state_delete(request, state_id):
    ...
    if request.method == "POST":
        state.delete()
        return redirect('state_list')
    return render(request, 'custom_admin/state_data/state_confirm_delete.html', {'state': state})
